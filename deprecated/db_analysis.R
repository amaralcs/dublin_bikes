"
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ OUTDATED ~~~~~~~~~~~~~~~~~~~~~
  See db_all_exploration for newest version

  Author: Carlos Amaral
  Date: 
  Last modified: 17/11/17
  Description: 
    Initial exploration of the dataset, in particular for Charlemont Station, since it is the
    busiest station.
    This contains some initial parsing and exploratory plots which are used in more robust
